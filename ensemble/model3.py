### Final Model 3 ###
# 2 convolutional layers, kernel size 7, 256 convolutional channels
# Only using word2vec
...
cnn.cpu()
torch.save(cnn, './ensemble_models/model3.pth')
...
create_csv_submission(ids, y_pred, 'kaggle_model_3.csv')
