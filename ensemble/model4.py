### Final Model 4 ###
# 2 convolutional layers, kernel size 3, 256 convolutional channels
...
cnn.cpu()
torch.save(cnn, './ensemble_models/model4.pth')
...
create_csv_submission(ids, y_pred, 'kaggle_model_4.csv')
