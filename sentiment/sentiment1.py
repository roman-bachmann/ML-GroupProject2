### Sentiment Model 1 ###
# 1 convolutional layer, kernel size 3, 265 convolutional channels
# Only using word2vec
...
cnn.cpu()
torch.save(cnn, './sentiment_models/sentiment_v1.pth')
...
create_csv_submission(ids, y_pred, 'kaggle_sentiment_v1.csv')
